...
class _ResultsScreenState extends State<ResultsScreen> {
      ...
      children: [
        SizedBox(
          ...
          child: PageView.builder(
            ...
            itemCount: (_selectedHotel['images'] as List).length,
        ...
        Row(
          ...
          children: List.generate(
            (_selectedHotel['images'] as List).length,
            (i) => Container(
              width: 8,
              height: 8,
              margin: const EdgeInsets.symmetric(horizontal: 3),
              decoration: BoxDecoration(
                color: i == 0 ? AppColors.primary : AppColors.tabInactive,
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  Row(
                    children: [
                      const Icon(LucideIcons.star,
                          color: AppColors.accentGold, size: 20, fill: 1.0),
                      const SizedBox(width: 4),
                      Text(_selectedHotel['rating'],
                          style: const TextStyle(
                              fontSize: 20,
                              fontWeight: FontWeight.w700,
                              color: AppColors.textPrimary)),
                  ...
                  Text('${_selectedHotel['reviews']} reviews',
                      style: const TextStyle(
          ...
          Text(_selectedHotel['description'],
              style: const TextStyle(
                  fontSize: 16,
  ...
  Widget _buildRoomTypes() {
    final rooms = _selectedHotel['rooms'] as List;
    return Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Wrap(
                            spacing: 10,
                            children: [
                              _RoomFeature(LucideIcons.bed, '${room['bed']}'),
                              _RoomFeature(LucideIcons.eye, '${room['view']}'),
                              _RoomFeature(
                                  LucideIcons.maximize2, '${room['size']}'),
                              _RoomFeature(LucideIcons.users,
                                  '${room['guests']} guests'),
                            ],
                          ),
                        ],
      ...
      child: Column(
        ...
        children: [
          ...
          Wrap(
            spacing: 8,
            runSpacing: 8,
            children: (_selectedHotel['amenities'] as List)
                .map((a) => Container(
          ...
          children: [
            ...
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text("GeesTrip Insider Tip",
                      style: TextStyle(
                          fontSize: 16,
                          fontWeight: FontWeight.w700,
                          color: AppColors.textPrimary)),
                  const SizedBox(height: 4),
                  Text(_selectedHotel['insiderTip'],
                      style: const TextStyle(
                          fontSize: 15,
                          color: AppColors.textSecondary,
                          height: 1.5)),
  ...
  Widget _buildOtherHotels() {
    final others =
        _hotels.where((h) => h['name'] != _selectedHotel['name']).toList();
    return Padding(
      padding: const EdgeInsets.all(20),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('You Might Also Like',
              style: TextStyle(
                  ...
                  color: AppColors.textPrimary)),
          const SizedBox(height: 12),
          ...others.map((hotel) => GestureDetector(
                onTap: () {
                  setState(() {
                    _selectedHotelIndex = _hotels.indexOf(hotel);
                    _selectedRoomIndex = 0;
                  ...
                  child: Row(
                    children: [
                      ClipRRect(
                        ...
                        child: Image.network(hotel['images'][0],
